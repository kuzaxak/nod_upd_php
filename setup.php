...
//Укажите логин и пароль для  V5, если они отличаются от V3.
...
// Настройки для верисии V6
    array(
        // Адрес сервера (Если закачка с офа, то строку 'host' надо заремить)
        //'host'=>'http://host.ru/eset_upd/v6/',
        // Web каталог для баз
        'www'=>'/var/www/nod326/',
        'user'=>$userV6,
        'password'=>$pswV6,
...
// Настройки для верисии V7
    array(
        // Адрес сервера (Если закачка с офа, то строку 'host' надо заремить)
        //'host'=>'http://host.ru/eset_upd/v7/',
        // Web каталог для баз
        'www'=>'/var/www/nod327/',
        'user'=>$userV7,
        'password'=>$pswV7,
